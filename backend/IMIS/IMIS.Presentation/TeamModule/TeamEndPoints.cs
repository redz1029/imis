...
namespace IMIS.Presentation.TeamModule
{
    public class TeamEndPoints : CarterModule
    {
        ...
        public override void AddRoutes(IEndpointRouteBuilder app)
        {
            ...
            .WithTags(_teamTag)
            .RequireAuthorization(e => e.RequireClaim(PermissionClaimType.Claim, _teamPermission.Add));
            ...
            .WithTags(_teamTag)
            .CacheOutput(builder => builder.Expire(TimeSpan.FromMinutes(0)).Tag(_teamTag), true)
