...
{
    public class ReportSWOTAnalysisServiceHeadDto : BaseDto<SWOTAnalysisServiceHead, long>
    {
        ...
        public ReportSWOTAnalysisServiceHeadDto() { }

        [SetsRequiredMembers]
        public ReportSWOTAnalysisServiceHeadDto(SWOTAnalysisServiceHead swotAnalysis)
        {
