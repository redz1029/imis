...
{
    public class ReportORPListDto : BaseDto<OperationReviewProtocol, long>
    {
        ...
        public ReportORPListDto()
        {
        }

        [SetsRequiredMembers]
        public ReportORPListDto(OperationReviewProtocol operationReviewProtocol)
        {
