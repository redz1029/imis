...
namespace IMIS.Application.PgsModule
{
    public interface IPerfomanceGovernanceSystemService : IService
    {
        ...
        Task<DtoPageList<PerfomanceGovernanceSystemDto, PerfomanceGovernanceSystem, long>> GetByUserIdAsync(string userId, string roleId, int page, int pageSize, CancellationToken cancellationToken);
