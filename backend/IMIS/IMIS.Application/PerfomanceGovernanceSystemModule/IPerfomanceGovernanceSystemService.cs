...
namespace IMIS.Application.PgsModule
{
    public interface IPerfomanceGovernanceSystemService : IService
    {
        ...
        Task<DtoPageList<PerfomanceGovernanceSystemDto, PerfomanceGovernanceSystem, long>>GetAuditorPgsDeliverableAsync(string roleId, long? parentofficeid, long? officeId, long? pgsPeriodId, int page, int pageSize, CancellationToken cancellationToken);
