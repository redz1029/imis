...
namespace IMIS.Application.PgsModule
{
    public interface IPerfomanceGovernanceSystemRepository : IRepository<PerfomanceGovernanceSystem, long>
    {
        ...
        Task<TotalDashboardOfficeDto> GetTotalOfficeAsync(List<int> officeIds, int? pgsPeriodId, int? parentOfficeId, CancellationToken cancellationToken);
        Task<TotalDashboardOfficeDto> GetTotalOfficeStandardUserAsync(List<int> officeIds, int? pgsPeriodId, CancellationToken cancellationToken);
        Task<DashboardAuditStatusDto> GetDashboardAuditStatusAsync(List<int> officeIds, int? pgsPeriodId, int? parentOfficeId, CancellationToken cancellationToken);
        Task<DashboardAuditStatusDto> GetDashboardAuditStatusStandardUserAsync(List<int> officeIds, int? pgsPeriodId, CancellationToken cancellationToken);
