...
namespace IMIS.Application.OfficeModule
{
    public interface IOfficeService : IService
    {
        ...
        Task<List<OfficeDto>?> GetOfficeByEvalutorRoleAsync(int? parentOfficeId, CancellationToken cancellationToken);
        ...
        Task<OfficeDto?> GetParentOfficeAsync(int officeId, CancellationToken cancellationToken);
    }
}
