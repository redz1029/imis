...
namespace IMIS.Persistence.SeedConfigurations
{
    ...
    {   
        ...
        {
            builder.HasData(
                new PgsSignatoryTemplate { Id = 1, Status = "Recommended", SignatoryLabel = "Recommended By", OrderLevel = 1, DefaultSignatoryId = "a6866933-92a9-41e7-9100-8bee51ed0ada", IsActive = true, IsDeleted = false, OfficeId = 1, Position = "Head, PGS" },
                ...
                new PgsSignatoryTemplate { Id = 4, Status = "Reviewed / Recommmended", SignatoryLabel = "Reviewed / Recommmended By", OrderLevel = 1, DefaultSignatoryId = "a6866933-92a9-41e7-9100-8bee51ed0ada", IsActive = true, IsDeleted = false, OfficeId = 2, Position = "Head, Medical Service/PGS" },
                ...
                new PgsSignatoryTemplate { Id = 8, Status = "Recommended", SignatoryLabel = "Recommended", OrderLevel = 2, DefaultSignatoryId = "a6866933-92a9-41e7-9100-8bee51ed0ada", IsActive = true, IsDeleted = false, OfficeId = 3, Position = "Head, PGS"},
                ...
                new PgsSignatoryTemplate { Id = 12, Status = "Recommended", SignatoryLabel = "Recommended By", OrderLevel = 2, DefaultSignatoryId = "a6866933-92a9-41e7-9100-8bee51ed0ada", IsActive = true, IsDeleted = false, OfficeId = 4, Position = "Head, PGS" },
                ...
                new PgsSignatoryTemplate { Id = 16, Status = "Recommended", SignatoryLabel = "Recommended By", OrderLevel = 2, DefaultSignatoryId = "a6866933-92a9-41e7-9100-8bee51ed0ada", IsActive = true, IsDeleted = false, OfficeId = 5, Position = "Head, PGS" },
                ...
                new PgsSignatoryTemplate { Id = 20, Status = "Recommended", SignatoryLabel = "Recommended By", OrderLevel = 2, DefaultSignatoryId = "a6866933-92a9-41e7-9100-8bee51ed0ada", IsActive = true, IsDeleted = false, OfficeId = 7, Position = "Head, PGS" },
                ...
                new PgsSignatoryTemplate { Id = 23, Status = "Recommended", SignatoryLabel = "Recommended By", OrderLevel = 1, DefaultSignatoryId = "a6866933-92a9-41e7-9100-8bee51ed0ada", IsActive = true, IsDeleted = false, OfficeId = 135, Position = "Head, PGS" },
