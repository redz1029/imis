...
class SummaryNarrativeReportPage extends StatefulWidget {
  const SummaryNarrativeReportPage({super.key});

  @override
  SummaryNarrativeReportPagetate createState() =>
      SummaryNarrativeReportPagetate();
}

class SummaryNarrativeReportPagetate extends State<SummaryNarrativeReportPage> {
