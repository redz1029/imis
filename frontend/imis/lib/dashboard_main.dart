...
class _DashboardMainPageState extends State<DashboardMain> {
                        ...
                        children: [
                          Expanded(
                              child: _buildDashboardBox(
                                  "Rejected", Colors.red, "10")),
                          SizedBox(width: 10),
                          Expanded(
                              child: _buildDashboardBox(
                                  "Processing", Colors.purple, "25")),
                          SizedBox(width: 10),
                          Expanded(
                              child: _buildDashboardBox(
                                  "Approved", Colors.green, "40")),
                        ],
                      ),
                      SizedBox(height: 20),
            ...
            Row(
              ...
              children: [
                _buildCircularIndicator(
                    "Competence", 0.4, const Color.fromARGB(139, 33, 149, 243)),
                _buildCircularIndicator("Resource Availability", 0.7,
                    const Color.fromARGB(255, 207, 193, 66)),
                _buildCircularIndicator("Confidence to Deliver", 0.9,
