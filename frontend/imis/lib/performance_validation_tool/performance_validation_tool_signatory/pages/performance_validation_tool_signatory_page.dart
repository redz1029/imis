...
class PerformanceValidationToolSignatoryPage extends StatefulWidget {
  ...
  @override
  PerformanceValidationToolSignatoryPageState createState() =>
      PerformanceValidationToolSignatoryPageState();
}

class PerformanceValidationToolSignatoryPageState
  ...
  PreferredSizeWidget _buildAppBar() => AppBar(
    ...
    title: Column(
      ...
      children: [
        Text(
          'Performance Validation Signatory Template',
          style: TextStyle(
            fontWeight: FontWeight.w700,
            fontSize: 24,
            color: kText,
