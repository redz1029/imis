...
import 'package:imis/performance_governance_system/pgs_operation_review_protocol/dialog/monthly_review_dialog_widget.dart';
...
class _PerformanceGovernanceSystemPageState
                              ...
                              ListView.builder(
                                ...
                                itemBuilder: (_, index) {
                                  ...
                                  final Color lineColor =
                                      isDone ? kSuccess : Colors.grey.shade200;
  ...
  Widget _buildStatusTabs() {
    final tabs = [
      ...
      ('Approved', _statusCounts['Approved'] ?? 0, kSuccess),
...
class _PgsFormDialog extends StatefulWidget {
  ...
  final String userId;
  final String? Function() lastResponseMessage;
  ...
  const _PgsFormDialog({
    ...
    required this.lastResponseMessage,
  });
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 10,
                      fontWeight: FontWeight.w600,
                      color: row.isDirect ? primaryColor : blue,
                    ),
                  ),
                ),
              ],
