...
class MonthlyOprReportPage extends StatefulWidget {
  const MonthlyOprReportPage({super.key});

  @override
  State<MonthlyOprReportPage> createState() => MonthlyOprReportPageState();
}

class MonthlyOprReportPageState extends State<MonthlyOprReportPage> {
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  'Summary of Offices with Monthly Operations Review Protocol',
                ...
                Text(
                  'Generate a filtered PGS report by office, and period produced operations review protocol ',
                  style: GoogleFonts.plusJakartaSans(
                    fontSize: 12,
                    color: kMuted,
                  ),
